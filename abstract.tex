...
\par In this paper we discuss and propose a solution which focuses on keeping the rate of false positives as low as possible and, at the same time, to maximize the detection rate. 
\end{abstract}
